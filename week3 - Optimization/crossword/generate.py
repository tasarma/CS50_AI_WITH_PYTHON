...
class CrosswordCreator():
        ...
        for var_1 in assignment:
            ...
            for var_2 in self.domains:
                ...
                if var_1 != var_2:
                    ...
                    # If there are no conflicts between neighboring variables
    ...
    def order_domain_values(self, var, assignment):
        ...
        domain_values.sort(key=lambda a : a[1])
    ...
    def select_unassigned_variable(self, assignment):
        ...
        mvr.append(min(unassignment, key=lambda x : x[1]))

        # Check if there is another variable with same number of remaining values
        for i in unassignment:
            if i[1] == mvr[0][1]:
                mvr.append(i)
        ...
        if len(mvr) > 1:
            # Choose the variable with the minimum number of remaining values in its domain
            return (max(mvr, key=lambda x : x[2]))[0]
